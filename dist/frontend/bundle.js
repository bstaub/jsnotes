...
var _ViewNew = __webpack_require__(331);
...
var _HttpService = __webpack_require__(339);
...
function start() {
  ...
  if (domlist) {
    ...
    var viewlist = new _ViewList2.default(new _HttpService2.default());
  ...
  var controllerlist = new _ControllerList2.default(new _HttpService2.default());
  if (domlist) {
...
var ViewHelper = function () {
  ...
  _createClass(ViewHelper, [{
    ...
    key: 'changeDropdownByValue',
    value: function changeDropdownByValue(selector, value) {
...
var Storage = function () {
  ...
  _createClass(Storage, [{
    ...
    value: function getNoteByID(id) {
      return this.getNotes().filter(function (note) {
    ...
    value: function updateNote(note) {
      ...
      var oldNote = notes.splice(index, 1);
...
var _Note = __webpack_require__(335);
...
var Controller = function () {
  ...
  _createClass(Controller, [{
    ...
    value: function clearAllImputs(dom) {
      ...
      _ViewHelper2.default.wichtigkeitClearAll(dom.stars);
    }
  }, {
...
var _HelperService = __webpack_require__(336);
...
var Note = function () {
  ...
  _createClass(Note, null, [{
    ...
    value: function buildNewNoteEntry(_ref) {
      ...
      return new Note(_HelperService2.default.getNewUniqueNoteID(), title.value, description.value, importance.value, _HelperService2.default.setFormatDateDMYhs(datepicker.value), _HelperService2.default.getCreatedDate(), isFinished);
    }
  }]);
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // const moment = require('moment');
...
var ControllerList = function () {
  ...
  _createClass(ControllerList, [{
      ...
      if (dom.dynamicList) {
        dom.dynamicList.addEventListener('click', function (e) {
          ...
          if (e.target.id === 'checkBoxisFinished') {
            ...
            document.querySelector('.note[data-id="' + _id2 + '"]').classList.toggle('finished');
      ...
      if (dom.btnSortByImportance) {
        dom.btnSortByImportance.addEventListener('click', function () {
          $(function () {
            ...
            var toggle = document.querySelector('#btnSortByImportance').classList.toggle('toggle');
            if (toggle == false) {
    ...
    value: function saveStarList(e) {
      if (this.api) {
        var note = { importance: e.target.id };
...
var HttpService = function () {
  ...
  _createClass(HttpService, [{
    ...
    key: 'patchNote',
    value: function patchNote(id, note) {
      // for just one atom value, ie importance, checkbox finished
      $.ajax({
        method: 'PATCH',
        url: '/api/notes/' + id + '/',
        data: note,
...
var listTemplateRestApi = __webpack_require__(364);
...
var _handlebarsBase = __webpack_require__(344);
...
var _handlebarsException = __webpack_require__(346);

var _handlebarsException2 = _interopRequireDefault(_handlebarsException);

var _handlebarsUtils = __webpack_require__(345);
...
var _exception = __webpack_require__(346);
...
module.exports = function isFinished(checkbool) {
  return checkbool ? 'finished' : '';
};
